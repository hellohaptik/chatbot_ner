...
def get_regex(message, entity_name, structured_value, fallback_value, bot_message, pattern, is_asr):
    ...
    """
    regex_detector = RegexDetector(entity_name=entity_name, pattern=pattern, is_asr=is_asr)
    if structured_value:
