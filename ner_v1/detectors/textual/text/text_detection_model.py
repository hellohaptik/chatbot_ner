...
from constant import ENTITY_VALUE_DICT_KEY
...
class TextModelDetector(TextDetector):
    ...
    model if trained.
    """
    def __init__(self, entity_name, source_language_script, read_model_from_s3=False, read_embeddings_from_remote_url=False,
