...
class TextModelDetector(TextDetector):
    ...
    def detect_entity(self, text, **kwargs):
        ...
        Args:
            text (str or unicode or list os strings): natural language sentence(s) to extract entities from
            **kwargs: it can be used to send specific arguments in future. for example, fuzziness, previous context.

        Returns:
            tuple:
                list or list of lists(bulk detect): containing list of dicts with the source of detection
