...
def v1_unpack_and_detect(parameters_dict, fn):
...
MAP = {
    'v1/text/': functools.partial(v1_unpack_and_detect, fn=get_text),
    'v1/location/': functools.partial(v1_unpack_and_detect, fn=get_location),
    'v1/phone_number/': functools.partial(v1_unpack_and_detect, fn=get_phone_number),
    'v1/email/': functools.partial(v1_unpack_and_detect, fn=get_email),
    'v1/city/': functools.partial(v1_unpack_and_detect, fn=get_city),
    'v1/pnr/': functools.partial(v1_unpack_and_detect, fn=get_pnr),
    'v1/shopping_size/': functools.partial(v1_unpack_and_detect, fn=get_shopping_size),
    'v1/passenger_count/': functools.partial(v1_unpack_and_detect, fn=get_passenger_count),
    'v1/number/': functools.partial(v1_unpack_and_detect, fn=get_number),
    'v1/time/': functools.partial(v1_unpack_and_detect, fn=get_time),
    'v1/time_with_range/': functools.partial(v1_unpack_and_detect, fn=get_time_with_range),
    'v1/date/': functools.partial(v1_unpack_and_detect, fn=get_date),
    'v1/budget/': functools.partial(v1_unpack_and_detect, fn=get_budget),
    'v1/person_name/': functools.partial(v1_unpack_and_detect, fn=get_person_name),
    'v1/regex/': functools.partial(v1_unpack_and_detect, fn=get_regex),
    'v2/date/': date_v2,
    'v2/time/': time_v2,
    'v2/number/': number_v2,
